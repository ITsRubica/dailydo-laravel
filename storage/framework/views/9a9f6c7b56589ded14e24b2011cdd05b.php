    ...
    <div class="card-body p-2 p-sm-3">
        <div class="d-flex justify-content-between align-items-start">
            <div class="d-flex align-items-start flex-grow-1">
                ...
                <div class="flex-grow-1">
                    <div class="d-flex align-items-center flex-wrap gap-1 mb-1">
                        <h6 class="card-title mb-0 fw-bold <?php echo e($task->status === 'completed' ? 'text-decoration-line-through text-muted' : ''); ?>" style="color: <?php echo e($task->status === 'completed' ? '#6c757d' : '#333'); ?>; font-size: 0.9rem;"><?php echo e($task->title); ?></h6>
                        <span class="badge px-2 py-1 d-flex align-items-center" style="background: <?php echo e($priorityColor); ?>; color: white; border-radius: 12px; font-size: 0.65rem; font-weight: 600;">
                            <i class="bi bi-<?php echo e($priorityIcon); ?> me-1" style="font-size: 0.6rem;"></i><span class="d-none d-sm-inline"><?php echo e(strtoupper($task->priority)); ?></span><span class="d-inline d-sm-none"><?php echo e(strtoupper(substr($task->priority, 0, 1))); ?></span>
                        </span>
                    ...
                    <?php if($task->description): ?>
                        <p class="card-text mb-1 <?php echo e($task->status === 'completed' ? 'text-muted' : ''); ?>" style="color: #666; line-height: 1.4; font-size: 0.8rem;"><?php echo e(Str::limit($task->description, 80)); ?></p>
                    <?php endif; ?>
            ...
            <div class="d-flex flex-column flex-sm-row gap-1 ms-2">
                <button class="btn btn-sm" onclick="editTask('<?php echo e($task->id); ?>')" title="Edit Task" style="background: #F1F0E4; color: #896C6C; border: 1px solid #DDDAD0; border-radius: 8px; padding: 3px 6px; transition: all 0.3s ease; font-size: 0.75rem;">
                    <i class="bi bi-pencil-square"></i>
                </button>
                <button class="btn btn-sm" onclick="deleteTask('<?php echo e($task->id); ?>')" title="Delete Task" style="background: #ffe6e6; color: #dc3545; border: 1px solid #ffcccc; border-radius: 8px; padding: 3px 6px; transition: all 0.3s ease; font-size: 0.75rem;">
