...
@section('title', 'Create Task - DailyDo')
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('tasks.store') }}" method="POST">
                        ...
                        <div class="mb-3" id="reminder-time-group" style="display: none;">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Show reminder time if it was previously checked
