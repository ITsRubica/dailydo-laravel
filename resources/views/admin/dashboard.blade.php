...
@section('title', 'User Management - DailyDo Admin')
        ...
        <div class="row mb-4">
            <div class="col-md-4">
                <div class="stats-card">
                    ...
                    <h3 class="fw-bold" id="totalUsers">{{ $totalUsers }}</h3>
            ...
            <div class="col-md-4">
                <div class="stats-card">
                    ...
                    <h3 class="fw-bold" id="activeUsers">{{ $activeUsers }}</h3>
            ...
            <div class="col-md-4">
                <div class="stats-card">
                    ...
                    <h3 class="fw-bold" id="newUsers">{{ $newUsers }}</h3>
